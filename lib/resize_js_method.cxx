...
JSBool TranslatorImpl::resizeMethod(JSContext *cx, uintN argc, jsval *vp)
{
	...
	// Applying resize operation to SCAD object and returning this Object
	reinterpret_cast<AbstractObject *>(JS_GetPrivate(cx, JS_THIS_OBJECT(cx, vp)))->resize(
