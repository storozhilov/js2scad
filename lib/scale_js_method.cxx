...
JSBool TranslatorImpl::scaleMethod(JSContext *cx, uintN argc, jsval *vp)
{
	...
	// Applying scale operation to SCAD object and returning this Object
	reinterpret_cast<AbstractObject *>(JS_GetPrivate(cx, JS_THIS_OBJECT(cx, vp)))->scale(
