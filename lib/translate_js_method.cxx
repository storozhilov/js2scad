...
JSBool TranslatorImpl::translateMethod(JSContext *cx, uintN argc, jsval *vp)
{
	...
	// Applying translate operation to SCAD object and returning this Object
	reinterpret_cast<AbstractObject *>(JS_GetPrivate(cx, JS_THIS_OBJECT(cx, vp)))->translate(
